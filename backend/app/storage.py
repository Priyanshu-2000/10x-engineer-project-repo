...
class Storage:
    ...
    def create_prompt(self, prompt: Prompt) -> Prompt:
        ...
        Args:
            prompt (Prompt): The prompt object to be added. It contains
                information like title, content, and optional description.
    ...
    def delete_prompt(self, prompt_id: str) -> bool:
        ...
        Returns:
            bool: True if the prompt was successfully deleted, False
                otherwise.
        """
    ...
    def get_collection(
        ...
        Returns:
            Optional[Collection]: The collection object if found, otherwise
                None.
        """
    ...
    def get_all_collections(self) -> List[Collection]:
        ...
        Returns:
            List[Collection]: A list containing all the collection objects
                stored.
        """
    ...
    def delete_collection(self, collection_id: str) -> bool:
        ...
        This method removes the collection from storage and disassociates
        any prompts linked to it.
        ...
        Returns:
            bool: True if the collection was successfully deleted, False if
    ...
    def get_prompts_by_collection(
        ...
        """Retrieve all prompts associated with a collection.

        Args:
            collection_id (str): The unique identifier for the collection.

        Returns:
            List[Prompt]: A list of prompts that belong to the collection.
        """
        return [
    ...
    def disassociate_prompts_from_collection(
        self,
        collection_id: str
    ):
        """Remove associations between prompts and a collection.

        For the given collection ID, this method updates each prompt within
        the collection, setting its collection ID to None, effectively
        disassociating it from the collection.

        Args:
            collection_id (str): The unique identifier for the collection
                from which prompts are to be disassociated.
        """
    ...
    def clear(self):
        ...
        This utility method clears the in-memory storage for both prompts
        and collections. It is useful for resetting the storage state,
        generally during testing or setup phases.
        """
        self._prompts.clear()
    ...
    def delete_version(self, version_id: str) -> bool:
        ...
        Args:
            version_id (str): The unique identifier for the version to
                delete.
    ...
    def get_prompt_versions(self, prompt_id: str) -> List[Version]:
        ...
        Returns:
            List[Version]: A list of version objects for the specified
                prompt.
        """
