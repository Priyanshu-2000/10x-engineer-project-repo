            ...
            >
              <div className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <svg className="w-5 h-5 text-gray-400 dark:text-gray-300 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-200 flex-shrink-0 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
